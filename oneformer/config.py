...
__all__ = ["add_common_config", "add_oneformer_config", "add_swin_config", 
            "add_dinat_config", "add_convnext_config", "add_fastervit_config"]
...
def add_fastervit_config(cfg):
    ...
    cfg.MODEL.FASTERVIT.NUM_HEADS = [4, 8, 16, 32]
    cfg.MODEL.FASTERVIT.WINDOW_SIZE = [7, 7, 40, 20]
    cfg.MODEL.FASTERVIT.CT_SIZE = 2
    cfg.MODEL.FASTERVIT.DIM = 196
    cfg.MODEL.FASTERVIT.IN_DIM = 64
    cfg.MODEL.FASTERVIT.USE_CHECKPOINT = False
    cfg.MODEL.FASTERVIT.MLP_RATIO = 4
    cfg.MODEL.FASTERVIT.DROP_PATH_RATE = 0.42
    cfg.MODEL.FASTERVIT.LAYER_SCALE = 1e-5
    cfg.MODEL.FASTERVIT.HAT = [False, False, False, False]
    # cfg.MODEL.FASTERVIT.DO_PROPAGATION = False
    cfg.MODEL.FASTERVIT.OUT_INDICES = [0, 1, 2, 3]
